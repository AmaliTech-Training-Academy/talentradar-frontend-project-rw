  ...
  return (
    <section className="relative py-8 sm:py-12 md:py-16 lg:py-20 xl:py-24 dark:bg-gradient-to-r from-violet/10 to-violet/50">
      ...
      >
            ...
            <CarouselItem key={slide.id}>
              <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 xl:gap-16 items-center px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12">
                <div className="flex flex-col items-start gap-4 sm:gap-6 lg:gap-8 order-2 lg:order-1">
                  <div className="inline-flex items-center gap-2 rounded-full px-2 sm:px-3 md:px-4 py-1 my-2 sm:py-2 md:py-3 text-[10px] sm:text-xs md:text-sm bg-violet/50/20 dark:bg-violet/40/20 font-bold border border-violet/50/30 dark:border-violet/400/30">
                ...
                <div className="relative flex justify-center lg:justify-end mt-4 sm:mt-6 lg:mt-0 order-1 lg:order-2 w-full max-w-md sm:max-w-lg lg:max-w-none mx-auto lg:mx-0">
                 <div className="relative w-full max-w-[200px] sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl mx-auto">
                <Image
                  src={slide.imageSrc || "/placeholder.svg"}
                  width={400}
                  height={400}
                  alt={slide.imageAlt}
                  className="rounded-lg shadow-xl object-cover rotate-3 w-full h-auto"
                  priority
                />
              </div>
                </div>
        ...
        <div className="flex justify-center gap-1.5 sm:gap-2 mb-[-30px] sm:mb-[-20px] absolute bottom-2 sm:bottom-4 left-1/2 -translate-x-1/2 z-20 md:bottom-[-5px]">
