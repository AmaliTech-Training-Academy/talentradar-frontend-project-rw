  ...
  return (
    <div className="  px-5 p-8 space-y-8">
      <div className="  border rounded-xl overflow-hidden">
        <div className="p-6 border-b bg-muted-foreground/5">
            ...
            <div className="p-6 border-b bg-muted-foreground/5">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  {selectedUserData && (
                    <div className="border bg-primary/10 rounded-lg p-4 flex items-center justify-between">
                      <div className="border rounded-lg flex items-center gap-3 ">
                        <Avatar className="h-12 w-12">
                          <AvatarImage
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {commentTypes.map((type, index) => (
                  <Card key={type.comment_id}>
                    ...
                    <CardContent>
                      <RichTextEditor
                        value={watch(`comments.${index}.comment_content`)}
                        onChange={(html: string) =>
                          setValue(`comments.${index}.comment_content`, html)
                        }
                      />
                      {errors.comments?.[index]?.comment_content && (
                        <p className="text-sm text-destructive mt-2">
                          {errors.comments[index]?.comment_content?.message}
                        </p>
                      )}
                    </CardContent>
                  </Card>
